<div class="p-customized w-100 h-100 d-flex">
			<div class="h-100 bg-light left-width d-sm-block d-none">
				<div class="p-3">
				...
				<div class="w-100 d-flex">
					<span class="my-auto w-100 border-top border-secondary"></span>
							...
							<div class="w-100">
								<form action="news.php" method="POST" enctype="multipart/form-data">
									...
									<div class="mt-2 w-100 text-right">
										...
										<button class="ml-1 btn-customized-alternativ rounded-pill" type="submit" name="posting" disabled="disabled">Publier</button>
									</div>
								</form>
							</div>
						</div>
